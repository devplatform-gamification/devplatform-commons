...
public class GitlabNote {
	...
	public GitlabNote objectKind(GitlabObjectKindEnum objectKind) {
	...
	public GitlabNote eventType(GitlabEventTypeEnum eventType) {
	...
	public GitlabNote user(GitlabUser user) {
		this.user = user;
		return this;
	}
	...
	public GitlabNote projectId(BigDecimal projectId) {
	...
	public GitlabNote project(GitlabProject project) {
	...
	public GitlabNote objectAttributes(GitlabNoteAttributes objectAttributes) {
	...
	public GitlabNote repository(GitlabRepository repository) {
	...
	public GitlabNote mergeRequest(GitlabMergeRequestAttributes mergeRequest) {
